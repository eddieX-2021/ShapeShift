    ...
    return (
      <div className="p-10 text-center space-y-8">
        ...
        <p className="text-lg text-muted-foreground max-w-xl mx-auto">
          Your AI-powered fitness assistant: track progress, plan workouts, and eat healthier.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="shadow hover:shadow-lg transition">
            <CardContent className="flex flex-col items-center">
              <img src="/stat.jpg" alt="Track Progress" className="h-32 w-full object-cover mb-4 rounded" />
              <h3 className="text-xl font-semibold mb-2">Track Progress</h3>
              <p className="text-sm text-muted-foreground">
                Log weight, BMI & body fat over time with intuitive charts.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow hover:shadow-lg transition">
            <CardContent className="flex flex-col items-center">
              <img src="/workout.jpg" alt="AI Workout" className="h-32 w-full object-cover mb-4 rounded" />
              <h3 className="text-xl font-semibold mb-2">AI Workout Plans</h3>
              <p className="text-sm text-muted-foreground">
                Get personalized workouts generated by state-of-the-art AI.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow hover:shadow-lg transition">
            <CardContent className="flex flex-col items-center">
              <img src="/food.jpg" alt="Nutrition Planner" className="h-32 w-full object-cover mb-4 rounded" />
              <h3 className="text-xl font-semibold mb-2">Diet & Nutrition</h3>
              <p className="text-sm text-muted-foreground">
                Plan meals, search foods & analyze macros for balanced eating.
              </p>
            </CardContent>
          </Card>
        </div>
